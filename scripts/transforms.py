...
def reverb(y, decay=0.5, sr=16000):
...
def equalize(y, gain_db=6, freq=1000, sr=16000):
...
def apply_transform(y, sr, transform="random"):
    ...
    transforms = {
        "resample": lambda: librosa.resample(y, orig_sr=sr, target_sr=random.choice([8000, 16000, 16000])),
